 ...
 * self-loops, parallel edges. Vertices are labeled by integers 0 .. n-1 The
 * edges of the graph are not labeled. Representation of edges is left abstract.
 */
public abstract class Graph {
     ...
     *
     * Each vertex has an in-degree (the number of edges leading into it) and an
     * out-degree (the number of edges leading out of it). The degree sequence
     * accounts for both.
     *
